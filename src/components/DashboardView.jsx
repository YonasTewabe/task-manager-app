...
export default function DashboardView({
  ...
  projects,
  assignedTasks,
  recentTasks: recentTasksProp = null,
  bucketCounts: bucketCountsProp = null,
  projectCards: projectCardsProp = null,
  projectById,
  ...
  const sortedTasks = Array.isArray(assignedTasks) ? assignedTasks : [];

  const assignedByBucket = {
    upcoming: Number(bucketCountsProp?.upcoming || 0),
              ...
              {projectCards.map((project) => (
                ...
                >
                  ...
                  <span className="grid min-w-0">
                    <strong className="truncate text-[0.9rem] text-gray-800">
                      {project.name}
                    </strong>
